        ...
        for (t in 1:nT){
          if (choice[s,rd,t] != 0){
            ...
            if (t<=nP1){
              ...
              Q[1] = Rmu[s,rd,t,opt1[s,rd,t]] + theta[s]*Smu[s,rd,t,opt1[s,rd,t]] + omega[s]*Ssig[s,rd,t,opt1[s,rd,t]]; 
              Q[2] = Rmu[s,rd,t,opt2[s,rd,t]] + theta[s]*Smu[s,rd,t,opt2[s,rd,t]] + omega[s]*Ssig[s,rd,t,opt2[s,rd,t]];
              target +=  categorical_logit_lpmf(choice[s, rd, t] | tau[s] * Q);
            }
        }
      }
